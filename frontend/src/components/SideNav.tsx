...
import { CaretSortIcon, TriangleDownIcon, LayersIcon, GearIcon, PersonIcon } from "@radix-ui/react-icons"
        ...
        <div className="flex h-full flex-col px-1 sm:px-5 py-4 md:px-0 border border-solid border-slate-200 divide-y divide-slate-200 ">
            <div className='flex flex-col gap-4 '>
                ...
                <div className='flex flex-col items-center pb-8'>
                    ...
                    <p className='text-xs sm:text-lg text-black-100 text-center'>School Name</p>
                </div>
            </div>
            ...
            >
                ...
                <div className='flex gap-2'>
                        <img src={Teaching} className='w-5 h-5 text-black hidden sm:block' alt='teaching'/>
                        <h4 className="text-xs sm:text-sm font-semibold">
                            Classes
                        </h4>
                    </div>
            ...
            >
                ...
                <div className='flex gap-2'>
                        <img src={Money} className='w-5 h-5 text-black hidden sm:block' alt='teaching'/>
                        <h4 className="text-xs sm:text-sm font-semibold">
                            Fee
                        </h4>
                    </div>
